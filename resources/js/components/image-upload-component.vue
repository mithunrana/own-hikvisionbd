...
<script>
    export default {
        ...
        methods:{
            init(){
                axios.get('/admin/getallimage').then(response=>{this.imageslist=response.data});
            },
            uploadNew(){
            ...
            formSubmit(e) {
                ...
                axios.post('/admin/formSubmit', formData, config).then(function (response) {
            ...
            },ConfirmDelete()
            {
                ...
                if (x){
                    ...
                    axios.post('/admin/generalimagedelete/'+this.id).then(response=>{
