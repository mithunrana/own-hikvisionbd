                            ...
                            <form action="{{url('admin/userdata-add')}}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6  col-lg-4">
                                            ...
                                            <input type="text" class="form-control" value="{{old('email')}}" placeholder="Enter Email Here" id="email" name="email" >
                                    </div>
                                    <div class="form-group col-6  col-lg-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-6 col-lg-6">
                                        ...
                                        <input type="text" class="form-control" value="{{old('country')}}" placeholder="Enter Client Country Name" id="country" name="country" >
                                    </div>
                                    <div class="form-group col-6 col-lg-6">
                                        ...
                                        <select id="activestatus" class="form-control" name="activestatus">
                                            <option selected disabled>SELECT CUSTOMER TYPE</option>/
                                            <option value="TechRegister" selected>Tech Register</option>/
