                                ...
                                <div class="col-sm-7">
                                    <form action="{{url('admin/update-sociallinks',[$SocialLinks->id])}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control{{$errors->has('visualtext') ? ' is-invalid' : ''}}" value="{{$SocialLinks->visualtext}}" id="visualtext"  name="visualtext" placeholder="Enter Visual Text" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="url">Link URL</label>
                                            <input type="text" class="form-control{{$errors->has('url') ? ' is-invalid' : ''}}" value="{{$SocialLinks->url}}" id="url" name="url" placeholder="Enter Links URL" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="sitename">Social Site Name</label>
                                            <input type="text" class="form-control{{$errors->has('sitename') ? ' is-invalid' : ''}}" value="{{$SocialLinks->sitename}}" id="sitename" name="sitename" placeholder="Enter Social Site Name" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="icon">Font Awesome</label>
                                            <input type="text" class="form-control{{$errors->has('icon') ? ' is-invalid' : ''}}" value="{{$SocialLinks->icon}}" id="icon" name="icon" placeholder="Enter Font Awesome Icon" readonly>
                                        </div>
                                        <a href="{{url('admin/sociallinks')}}" class="btn btn-primary">Back</a>
                                    </form>
                                </div>
                                <div class="col-sm-5">
