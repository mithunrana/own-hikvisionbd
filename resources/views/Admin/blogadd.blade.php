                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;"  type="text" placeholder="Enter Blog Name" class="form-control{{$errors->has('BlogName') ? ' is-invalid' : ''}}" value="{{old('BlogName')}}" name="BlogName" id="BlogName">
                                        </div>
                                        <div class="form-group">
                                            <label for="SeoKeyword">SEO Keyword:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" placeholder="Enter Service Related Keyword" name="SeoKeyword" id="SeoKeyword"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="SeoDescription">SEO Description:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" placeholder="Enter SEO Description" name="SeoDescription" id="SeoDescription"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('VideoURL') ? ' is-invalid' : ''}}" value="{{old('VideoURL')}}" placeholder="Enter Video URL" name="VideoURL" id="VideoURL">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="EmbeddedVideo">Embedded Video:</label>
                                            <input style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('EmbeddedVideo') ? ' is-invalid' : ''}}" value="{{old('EmbeddedVideo')}}" placeholder="Enter Embedded Video" name="EmbeddedVideo" id="EmbeddedVideo">
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="StructuredData">Structured Data :</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" placeholder="Enter Service Structured Data" name="StructuredData" id="StructuredData"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="BlogDetails">Blog Details:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('BlogDetails') ? ' is-invalid' : ''}}"  rows="7" placeholder="Enter Service Structured Data" name="BlogDetails" id="BlogDetails">{{old('BlogDetails')}}</textarea>
                                        </div>
                                    </div>
                                </div>
