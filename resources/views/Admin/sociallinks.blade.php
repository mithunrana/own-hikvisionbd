                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-7">
                                    <form action="{{url('admin/sociallinks')}}" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            <label for="visualtext">Visual Text</label>
                                            <input type="text" class="form-control{{$errors->has('visualtext') ? ' is-invalid' : ''}}" value="{{old('visualtext')}}" id="visualtext"  name="visualtext" placeholder="Enter Visual Text">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control{{$errors->has('sitename') ? ' is-invalid' : ''}}" value="{{old('sitename')}}" id="sitename" name="sitename" placeholder="Enter Social Site Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="icon">Font Awesome</label>
                                            <input type="text" class="form-control{{$errors->has('icon') ? ' is-invalid' : ''}}" value="{{old('icon')}}" id="icon" name="icon" placeholder="Enter Font Awesome Icon">
                                        </div>
