            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('admin/solutions-store')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input style="border: 1px solid #586bde;"  type="text" class="form-control{{$errors->has('SolutionsName') ? ' is-invalid' : ''}}" value="{{old('SolutionsName')}}" name="SolutionsName" id="SolutionsName">
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="SolutionShortText">Solution Short Details:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Service Structured Data" name="SolutionShortText" id="SolutionShortText">{{old('SolutionShortText')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="SolutionsDetails">Solution Details:</label>
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control" rows="7" placeholder="Enter Events Details" name="SolutionsDetails" id="SolutionsDetails">{{old('SolutionsDetails')}}</textarea>
                                        </div>
                                    </div>
                                </div>
