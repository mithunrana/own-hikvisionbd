        ...
        <section id="app" style="margin-top: 10px;" class="content">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <div class="card">
                        <div class="card-header">Product Secondary Category</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-7">
                                    <form action="{{url('admin/products-secondary-store')}}" method="POST">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="CategoryName">Secondary Category Name</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control{{$errors->has('CategorySeoKeyword') ? ' is-invalid' : ''}}" value="" id="CategorySeoKeyword" name="CategorySeoKeyword" placeholder="Enter SEO Keyword....">{{old('CategorySeoKeyword')}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="CategorySeoDescription">SEO Description</label>
                                            <textarea type="text" class="form-control{{$errors->has('CategorySeoDescription') ? ' is-invalid' : ''}}" value="" id="CategorySeoDescription" name="CategorySeoDescription" placeholder="Enter SEO Description....">{{old('CategorySeoDescription')}}</textarea>
                                        </div>
