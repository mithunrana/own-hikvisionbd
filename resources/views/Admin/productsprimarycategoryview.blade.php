        ...
        <section id="app" style="margin-top: 10px;" class="content">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    @endif
                    <div class="card">
                        <div class="card-header">Products Primary Category View</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-7">
                                    <form action="#" method="">
                                        ...
                                        <a href="{{url('admin/products-primary-category')}}" class="btn btn-primary">BACK</a>
                                    </form>
                                </div>
                                <div class="col-sm-5">
                                        ...
                                        @foreach(App\ProductsPrimaryCategory::all() as $Category)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{url('delete-products-primary-category',[$Category->id])}}" class="btn btn-danger" onclick="return ConfirmDelete();" ><i class="fas fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
