                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('EmbeddedCode') ? ' is-invalid' : ''}}" placeholder="Enter Embedded Video Text" name="EmbeddedCode" id="EmbeddedCode">{{$Products->EmbeddedCode}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea style="border: 1px solid #586bde;" type="text" class="form-control{{$errors->has('OptionalContent') ? ' is-invalid' : ''}}" placeholder="Enter Extra Content" name="OptionalContent" id="OptionalContent">{{$Products->OptionalContent}}</textarea>
                                        </div>
                                    </div>
                                </div>
